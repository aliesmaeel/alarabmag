...
<footer>
    <div class="footer-top">
        <div style="text-align:right;">
            ...
            <p class="footer-about">
                @if($variant === 'full')
                    <strong>مجلة العرب</strong> (Al Arab Magazine) — المجلة العربية الأولى التي تحتفي بالإنسان العربي المتميّز في كل مكان. نحكي قصص المؤثرين والفنانين والأطباء ورواد الأعمال الذين يُلهمون الأمة. صادرة من الشارقة، للعالم العربي.
                @else
    ...
    <div class="footer-bottom">
        ...
        <div class="fcopy">© 2026 مجلة العرب. جميع الحقوق محفوظة.@if($variant === 'full') Sharjah Media City Free Zone، الشارقة، الإمارات العربية المتحدة.@endif</div>
    </div>
</footer>
