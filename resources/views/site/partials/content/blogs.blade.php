...
<section class="page-hero">
    ...
    <h1 class="page-hero-title">سكوب <em>العرب</em></h1>
    <p class="page-hero-sub">آراء، تجارب، وقصص شخصية من كتّاب ومفكّرين ومبدعين عرب — حيث تلتقي الكلمة بالفكر وتتحوّل
        القصة إلى مرآة لزماننا.</p>
    <div class="crumb">
        <a href="/">الرئيسية</a>
        <span>›</span>
        <span>المدونات</span>
...
<!-- TAG FILTERS -->
<div class="sh">
    <div class="sh-title">استكشف المدونات حسب الموضوع</div>
    <div class="sh-rule"></div><span class="sh-more" id="resultsCount">—</span>
</div>
