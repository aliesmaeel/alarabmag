...
class SiteSeoDefaults
{
    ...
    public static function pageMeta(): array
    {
        ...
        return [
            ...
            'vote' => [
                'label' => 'أغنية العام',
                'title' => "صوّت: أفضل 10 أغاني عربية 2025 — {$brand}",
                'description' => 'صوّت لأغنية العام — اختيار مجلة العرب لأبرز الأغاني العربية في 2025. صوت واحد لكل قارئ.',
                'keywords' => "تصويت, أغنية العام, أغاني عربية 2025, عمرو دياب, نانسي عجرم, {$base}",
            ],
            'about' => [
                'label' => 'عن المجلة',
                'title' => "{$brand} — عن المجلة",
                'description' => "تعرّف على مجلة العرب ({$en}) — المجلة العربية الأولى التي تحتفي بالإنسان العربي المتميّز، صادرة من الشارقة للعالم العربي.",
