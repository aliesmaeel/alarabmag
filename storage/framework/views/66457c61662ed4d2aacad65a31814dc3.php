    ...
    <div class="hero-main">
      <div class="hero-img-wrap">
        ...
        <div class="hero-content">
          ...
          <h1 class="hero-headline">أحمد الراشدي:<br>الرجل الذي <em>يُعيد كتابة</em><br>قواعد الاقتصاد العربي</h1>
...
<div class="cats-section">
  ...
  <div class="cats-grid">
    ...
    <a href="<?php echo e(route('business.index')); ?>" class="cat-card">
      <span class="cat-icon">💼</span>
    ...
    <a href="<?php echo e(route('fashion.index')); ?>" class="cat-card">
      <span class="cat-icon">👗</span>
...
<!-- FEATURED STORIES -->
<div id="business">
  <div class="sh"><div class="sh-title">الأعمال العربية</div><div class="sh-rule"></div><a href="<?php echo e(route('business.index')); ?>" class="sh-more">جميع القصص →</a></div>
...
<!-- FASHION -->
<div id="fashion">
  <div class="sh"><div class="sh-title">الموضة العربية</div><div class="sh-rule"></div><a href="<?php echo e(route('fashion.index')); ?>" class="sh-more">كل الموضة →</a></div>
...
<?php /**PATH /home/ali/Downloads/alarab/alarab-laravel-project/alarab-laravel/resources/views/site/partials/content/index.blade.php ENDPATH**/ ?>